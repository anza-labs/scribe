...
func (r *DeploymentReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	log.V(2).Info("Reconciling Deployment", "request", req)
...
func (r *DeploymentReconciler) listObjects(ctx context.Context, namespace string) ([]types.NamespacedName, error) {
